...
**当前规模**（2026-09-23）：**68 个页面** —— 9 个 source、7 个 entity、44 个 concept、3 个 synthesis，另加 5 个元页面（`index` / `log` / `overview` 与两份体检报告）；知识图谱 **68 节点 / 367 条边**（353 条确定性抽取 + 14 条语义推断）/ **8 个社区**。
